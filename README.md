...
- Step 02: Get Dataset
    ...
    - AIdea AOI Detection: [https://aidea-web.tw/topic/285ef3be-44eb-43dd-85cc-f0388bf85ea4](https://aidea-web.tw/topic/285ef3be-44eb-43dd-85cc-f0388bf85ea4)
        ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step02_01.png)

    - Download Page:

        ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step02_02.png)
...
- Step 03: Arrange File Structure
    - 預期的專案結構如下:
        ...
        ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step03_01.png)

    - train_images

        ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step03_02.png)

    - train.csv

        ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step03_03.png)
...
![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step03_05.png)
...
- Step 04: Have a look of image
    ...
    - Conclusion:
        ...
        ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step04_01.png)
...
- Step 07: Define LeNet5-like Structure
    - Yann Lecun
        ...
        ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step07_01.png)

        - Original Version of LeNet5 in his [paper](http://yann.lecun.com/exdb/publis/pdf/lecun-98.pdf).

        ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step07_02.png)

    - Structure of Original LeNet5

        ![](https://github.com/AI-FREE-Team/DeepLearning/HW3/imgs/LeNet_Mnist.png)
    ...
    - API lookup [[Link](https://pytorch.org/docs/stable/index.html)]
        - Conv2D [[Link](https://pytorch.org/docs/1.7.1/generated/torch.nn.Conv2d.html#torch.nn.Conv2d)]
            ...
            ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step07_03.png)
...
- Step 09: Training Phase
    ...
    ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step09_00.png)

    - Why zero_grad
        - What step(), backward(), and zero_grad() do [[Link](https://discuss.pytorch.org/t/what-step-backward-and-zero-grad-do/33301)]

            ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step09_01.png)
...
- Step 10: Plot Accuracy & Loss Curves
    ...
    ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step10_01.png)

    ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step10_02.png)
...
- Step 11: Testing Phase
    ...
    ![](https://github.com/AI-FREE-Team/AOI_Practice_in_PyTorch/blob/main/imgs/step11_01.png)
